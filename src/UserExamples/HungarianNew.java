...
public class HungarianNew {
    ...
    public static int[][] getAssignment(double[][] optimal,String sumType){
        ...
        int[][] assignment = new int[optimal.length][2];
        assignment = hgAlgorithm(optimal, sumType);	//Call Hungarian algorithm.
